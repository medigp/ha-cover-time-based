export const EN = {
  ...
  "timing.bottom_open_delay_from_closed": "Bottom open delay from closed",
  "timing.bottom_open_delay_from_closed_helper": "Extra seconds spent opening from 0% before the visible cover position starts increasing. Only applies when opening from fully closed.",
  "timing.bottom_close_delay_to_closed": "Bottom close delay to closed",
  "timing.bottom_close_delay_to_closed_helper": "Extra seconds spent after the visible cover position reaches 0% while closing to fully closed. The cover stays in closing state until this time finishes.",
...
export const TRANSLATIONS = {
  ...
  ca: {
    ...
    "timing.bottom_open_delay_from_closed": "Temps extra en obrir des de tancada",
    "timing.bottom_open_delay_from_closed_helper": "Segons extra que s'afegeixen quan s'obre des del 0%, abans que la posició visible comenci a pujar. Només s'aplica quan s'obre des de completament tancat.",
    "timing.bottom_close_delay_to_closed": "Temps extra en acabar de tancar",
    "timing.bottom_close_delay_to_closed_helper": "Segons extra que s'afegeixen després que la posició visible arribi al 0%, mentre la persiana acaba el moviment físic. La persiana continua en estat de tancament fins que aquest temps acaba.",
  ...
  es: {
    ...
    "timing.bottom_open_delay_from_closed": "Tiempo extra al abrir desde cerrada",
    "timing.bottom_open_delay_from_closed_helper": "Segundos extra que se añaden al abrir desde el 0%, antes de que la posición visible empiece a subir. Solo se aplica al abrir desde completamente cerrado.",
    "timing.bottom_close_delay_to_closed": "Tiempo extra al terminar de cerrar",
    "timing.bottom_close_delay_to_closed_helper": "Segundos extra que se añaden después de que la posición visible llegue al 0%, mientras la persiana termina el movimiento físico. La persiana sigue en estado de cierre hasta que termina este tiempo.",
  ...
  pt: {
    ...
    "timing.bottom_open_delay_from_closed": "Atraso ao abrir a partir de fechado",
    "timing.bottom_open_delay_from_closed_helper": "Segundos extra ao abrir a partir de 0% antes de a posição visível começar a aumentar. Só se aplica ao abrir a partir de totalmente fechado.",
    "timing.bottom_close_delay_to_closed": "Atraso ao fechar até fechado",
    "timing.bottom_close_delay_to_closed_helper": "Segundos extra depois de a posição visível chegar a 0% ao fechar até totalmente fechado. O estore continua no estado a fechar até este tempo terminar.",
  ...
  pl: {
    ...
    "timing.bottom_open_delay_from_closed": "Opóźnienie otwierania z zamknięcia",
    "timing.bottom_open_delay_from_closed_helper": "Dodatkowe sekundy przy otwieraniu od 0%, zanim widoczna pozycja rolety zacznie rosnąć. Dotyczy tylko otwierania z pełnego zamknięcia.",
    "timing.bottom_close_delay_to_closed": "Opóźnienie zamykania do zamknięcia",
    "timing.bottom_close_delay_to_closed_helper": "Dodatkowe sekundy po osiągnięciu widocznej pozycji 0% podczas zamykania do pełnego zamknięcia. Roleta pozostaje w stanie zamykania do końca tego czasu.",
