...
export const TRANSLATIONS = {
  en: EN,
  ca: {
    "timing.bottom_retract_time_open": "Temps de recollida inferior en obrir",
    "timing.bottom_retract_time_open_helper": "Segons extra en obrir des del 0% mentre les lames inferiors es recullen abans que la posició visible comenci a pujar. Només s'aplica quan s'obre des de completament tancat.",
    "timing.bottom_deploy_time_close": "Temps de desplegament inferior en tancar",
    "timing.bottom_deploy_time_close_helper": "Segons extra després que la posició visible arribi al 0%, mentre les lames inferiors es despleguen o s'assenten. La persiana continua en estat de tancament fins que aquest temps acaba.",
  },
  es: {
    "timing.bottom_retract_time_open": "Tiempo de recogida inferior al abrir",
    "timing.bottom_retract_time_open_helper": "Segundos extra al abrir desde el 0% mientras las lamas inferiores se recogen antes de que la posición visible empiece a subir. Solo se aplica al abrir desde completamente cerrado.",
    "timing.bottom_deploy_time_close": "Tiempo de despliegue inferior al cerrar",
    "timing.bottom_deploy_time_close_helper": "Segundos extra después de que la posición visible llegue al 0%, mientras las lamas inferiores se despliegan o se asientan. La persiana sigue en estado de cierre hasta que termina este tiempo.",
  },
  pt: {
