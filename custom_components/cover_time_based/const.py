...
CONF_BOTTOM_OPEN_DELAY_FROM_CLOSED = "bottom_open_delay_from_closed"
CONF_BOTTOM_CLOSE_DELAY_TO_CLOSED = "bottom_close_delay_to_closed"
...
DEFAULT_BOTTOM_OPEN_DELAY_FROM_CLOSED = 0.0
DEFAULT_BOTTOM_CLOSE_DELAY_TO_CLOSED = 0.0
